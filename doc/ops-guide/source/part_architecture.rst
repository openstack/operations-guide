...
where privileged administrator commands are necessary. ? shows the most
common, but not the only logical architecture for an OpenStack cloud.

.. image:: figures/osog_0001.png
